...
public class AnimalRunner {
    ...
    4)Paren Class Object'leri Child Class'dan method ve variable'lari
    kullanamazlar.
    ...
    6)"private" method ve variable'lar Child Class'lar tarafindan kullanilamaz.
      ...
      "protected" method ve variable'lar Child Class'lar tarafından kullanilabilir.
    ...
    7)4 tip inheritance vardir.
      i)Multilevel Inheritance: Jva bunu kabul eder
     ii)Hierarchical Inheritance : Bir parent icin coklu child, Java bunu kabul eder.
    iii)Multiple Inheritance : Bir Child'a coklu Parent,Java bunu deteklemez.(Java does not support Multiple Inheritance)
